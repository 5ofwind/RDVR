...
def cal_psnr_ssim(sr_img, gt_img, lr_img, lrgt_img):
    # save images
    suffix = opt['suffix']
    if suffix:
...
for test_loader in test_loaders:
    ...
    with open(osp.join(opt['path']['log'], 'test_' + opt['name'] + '_test.csv'), 'w') as f:
        ...
        for data in test_loader:
            ...
            #print(osp.dirname(data['GT_path'][0][0]))
            ...
            if test_set_name == 'Vimeo90K':
                ...
                test_results = cal_psnr_ssim(sr_img, gt_img, lr_img, lrgt_img)
