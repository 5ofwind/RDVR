...
class Quantization_H265_Stream:
    def __init__(self,q = 17,keyint = 12,scale_times = 2,opt = None):
        ...
        self.h265_all_default=True
        print(self.h265_all_default)
    ...
    def open_writer(self,dev_id,w,h ):
        ...
        self.h = h
        self.video_frame_num = 0
        self.video_name = "./tmp/outputvideo"+str(dev_id)+"cvb.mkv"
    ...
    def write_multi_frames(self,input):
        ...
        output222 = (input * 255.0).round()
        bt,c,h,w =output222.size()
        self.h = h
        self.w = w
        
        frames = output222.permute(0,2,3,1)
        ...
        for i in range(bt):
            ...
            self.rgb_yuv_writter.writeFrame(frames[0, :, :, (i*3):(i*3+3)])
    ...
    ### return bpp
        ...
        print("bpp",bpp)
        # exit(0)
        return torch.autograd.Variable(torch.Tensor([bpp])),bpp########################,bpp
